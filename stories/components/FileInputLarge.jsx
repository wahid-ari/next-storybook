...
export default function FileInputLarge({
	...
	return (
		<div className="mb-4">
			<label
				className="block text-sm font-medium text-gray-800 dark:text-neutral-300 mt-2 mb-4"
				htmlFor={name}
			>
				{label}
			</label>
        ...
        hover:bg-gray-100 dark:hover:bg-neutral-800 `}
			>
				<div className="flex flex-col items-center py-3">
					{icon ? icon : ""}
					<p className="pt-1 text-xs tracking-wider text-gray-400">
						{inputLabel}
					</p>
					{value ? (
